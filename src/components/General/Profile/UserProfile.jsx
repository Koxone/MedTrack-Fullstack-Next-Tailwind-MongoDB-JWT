...
export default function UserProfile() {
  ...
  if (role === 'medic')
    return (
      <div className="space-y-6">
        ...
        {/* Información Profesional mejorada */}
  ...
  if (role === 'employee') {
    ...
    return (
      <div className="space-y-6">
        {/* Header con gradiente para empleado */}
  ...
  if (role === 'patient')
    return (
      <div className="space-y-6">
        {/* Header con gradiente para paciente */}
...
function InfoCard({ icon: Icon, label, value, color = 'gray' }) {
  ...
  return (
    ...
    >
      <div
        className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-white shadow-sm transition-transform duration-200 group-hover:scale-110`}
      >
