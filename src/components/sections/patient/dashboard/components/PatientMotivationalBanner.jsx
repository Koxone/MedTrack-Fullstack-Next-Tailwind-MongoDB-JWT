  ...
  return (
    <div className="bg-medtrack-blue-solid rounded-xl p-4 text-white shadow-sm md:p-6">
      <div className="flex items-start gap-4">
        <div className="bg-medtrack-body-main/20 rounded-lg p-3" aria-hidden />
        <div className="flex-1">
          ...
          <button className="bg-medtrack-body-main rounded-lg px-4 py-2 text-sm font-medium text-blue-600 transition hover:bg-blue-50 active:scale-95">
            Ver mi progreso
          </button>
        </div>
      </div>
